...
const cardData = [
  {
    ...
    quote: "Thanks to DevLink, I landed my dream job as a Senior Web Developer. It's a game-changer for my career!",
    author: "John Smith",
  },
  {
    imageAlt: "XYZ Comapny",
    image: xyzComapnyImage,
    quote: "We've found top-notch web development talent through DevLink, which has significantly improved our project outcomes.",
    author: "XYZ Company",
  },
  {
    imageAlt: "Jane Doe",
    image: jandeDoeImage,
    quote: "As a freelancer, DevLink has helped me secure consistent work at competitive rates. It's a win-win for developers and clients.",
    author: "Jane Doe",
  },
        ...
        <div className="mx-auto max-w-2xl py-16">
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-400">
                DevLink has helped thousands of developers and hiring agents over the years.
            </p>
            <p className="mt-6 text-lg leading-8 text-gray-400">
